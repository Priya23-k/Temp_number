  ...
  fetch('/data/data.json') // Path to your JSON file
    ...
    .then(data => {
      ...
      if (serviceDropdown && data.services) {
        ...
        // Add event listener to update the URL and content when the customer selects a new service
      ...
      if (countryDropdown && data.countries) {
        ...
        // Add event listener to update the URL when the customer selects a new country
